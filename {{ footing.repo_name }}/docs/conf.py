# -*- coding: utf-8 -*-
#
# {{ footing.repo_name }} documentation build configuration file, created by
...
version = {{ footing.module_name }}.__version__
...
htmlhelp_basename = "{{ footing.repo_name }}doc"
...
latex_documents = [
    (
        master_doc,
        "{{ footing.repo_name }}.tex",
        "{{ footing.repo_name }} Documentation",
        "Opus 10",
        "manual",
    )
]
